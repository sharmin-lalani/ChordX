...
public class ChordNodeImpl extends UnicastRemoteObject implements ChordNode{
	...
	// ftsize and maxNodes in ChordNodeImpl should be same as
	// m and maxNodes in BootStrapNodeImpl.
	public static int ftsize = 5; // finger table size
	public static int maxNodes = 32; // maxNodes = 2^ftsize
	...
	*/
	...
	public void run(Result result) {
		...
		for(int i = 2; i <= ftsize; i++){
			int start = (this.node.nodeID + (int) Math.pow(2,i-1)) % maxNodes;
	...
	public void print_finger_table() throws RemoteException {
		...
		System.out.println("Index\tStart\tSuccessor ID\tIP Address\tPort");
